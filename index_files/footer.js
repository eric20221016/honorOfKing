...
var pvpFooter = (function(){
	...
	util.addFooterCSS = function(){
		var footerCSS = '';
			footerCSS += '.footer-wrap{position:relative;z-index:2;height:362px;background:url(https://game.gtimg.cn/images/yxzj/web201605/top_banner/bg_footer.jpg) no-repeat center 0;}';
			...
			footerCSS += '.footer-wrap .foot_ieg_logo{width:285px;height:64px;margin:0;background: url(https://game.gtimg.cn/images/yxzj/web201605/main/spr.png) no-repeat;}';
			footerCSS += '.footer-wrap .logo1{width:70px;height:64px;margin:0;background: url(https://game.gtimg.cn/images/yxzj/web201605/main/spr.png) no-repeat -285px 0;}';
